    ...
    <>
      ...
      >
        ...
        <style>{`
          ...
          /* Hover target: expand and animate into view */
          .plant-btn:hover .icon-1 {
            top: -220%;
            opacity: 1;
            width: 50px;
            animation: inIcon1 1000ms ease 450ms forwards;
          }
          .plant-btn:hover .icon-2 {
            ...
            opacity: 1;
            width: 75px;
            animation: inIcon2 1000ms ease 450ms forwards;
          }
          .plant-btn:hover .icon-3 {
            ...
            opacity: 1;
            width: 60px;
            animation: inIcon3 1000ms ease 450ms forwards;
          }
          .plant-btn:hover .icon-4 {
            ...
            opacity: 1;
            width: 85px;
            animation: inIcon4 1000ms ease 450ms forwards;
          }
          .plant-btn:hover .icon-5 {
            ...
            opacity: 1;
            width: 85px;
            animation: inIcon5 1000ms ease 450ms forwards;
          }

          /* keyframes (slight rotation wobbles) */
          @keyframes inIcon1 {
          ...
          /* subtle button hover morph */
          .plant-btn:hover {
            padding-left: 6.25rem; /* 25px -> 25px scaled to Tailwind px */
