...
const Interview = () => {
	...
	const GetInterviewDetails = async () => {
		...
		try {
			...
			console.log("Interviews for get interview details")
	...
	return (
		<div className='px-10 md:px-28 lg:px-48 xl:px-64 mt-16'>
			<div className='flex flex-col items-center p-7 lg:px-33 xl:px-52 justify-center border mb-20 rounded-lg shadow-md'>
				...
				<div className='w-full'>
					...
					<Input placeholder='e.g. John Smith' className={`mt-2`} onChange={(event) => setUserName(event.target.value)} />
				</div>
				<div className='w-full mt-3'>
					<h2>Enter your email</h2>
					<Input placeholder='e.g. johnsmith@gmail.com' className={`mt-2`} onChange={(event) => setUserEmail(event.target.value)} />
				</div>
